          ...
          <!-- /. Start the progress work from here -->
           ...
           <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3><?php echo $this->db->count_all_results('fakeuser') ?></h3>
 ...
 <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3><?php echo $this->db->count_all_results('fakeuser') ?><sup style="font-size: 20px">%</sup></h3>
    ...
    <div class="form-group">
      ...
      <input type="password" class="form-control" id="username" placeholder="Enter new passoword" name="newpassword">
    </div>
                 </form>
            </div>
          <div class="modal-footer">
